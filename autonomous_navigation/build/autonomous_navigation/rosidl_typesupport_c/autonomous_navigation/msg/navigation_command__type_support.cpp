...
static const _NavigationCommand_type_support_symbol_names_t _NavigationCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autonomous_navigation, msg, NavigationCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autonomous_navigation, msg, NavigationCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autonomous_navigation, msg, NavigationCommand)() {
  return &::autonomous_navigation::msg::rosidl_typesupport_c::NavigationCommand_message_type_support_handle;
}

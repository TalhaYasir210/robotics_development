...
#include "autonomous_navigation/msg/detail/navigation_command__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_autonomous_navigation
...
using _NavigationCommand__ros_msg_type = autonomous_navigation__msg__NavigationCommand;
...
bool cdr_serialize_autonomous_navigation__msg__NavigationCommand(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: is_waypoint_nav
  {
    cdr << (ros_message->is_waypoint_nav ? true : false);
  }
  ...
  autonomous_navigation__msg__NavigationCommand * ros_message)
{
  // Field name: is_waypoint_nav
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->is_waypoint_nav = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: is_waypoint_nav
  {
    size_t item_size = sizeof(ros_message->is_waypoint_nav);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autonomous_navigation__msg__NavigationCommand;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const autonomous_navigation__msg__NavigationCommand * ros_message = static_cast<const autonomous_navigation__msg__NavigationCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_autonomous_navigation__msg__NavigationCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  autonomous_navigation__msg__NavigationCommand * ros_message = static_cast<autonomous_navigation__msg__NavigationCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_autonomous_navigation__msg__NavigationCommand(cdr, ros_message);
}

static uint32_t _NavigationCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autonomous_navigation__msg__NavigationCommand(
...
static size_t _NavigationCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autonomous_navigation__msg__NavigationCommand(

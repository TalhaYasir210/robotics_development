...
static const _NavigationCommand_type_support_symbol_names_t _NavigationCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autonomous_navigation, msg, NavigationCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autonomous_navigation, msg, NavigationCommand)),
  }
};
...
{
  return &::autonomous_navigation::msg::rosidl_typesupport_cpp::NavigationCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autonomous_navigation, msg, NavigationCommand)() {
  return get_message_type_support_handle<autonomous_navigation::msg::NavigationCommand>();
}

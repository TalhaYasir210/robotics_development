...
#include "autonomous_navigation/msg/detail/navigation_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autonomous_navigation
cdr_serialize(
  const autonomous_navigation::msg::NavigationCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autonomous_navigation::msg::NavigationCommand & ros_message)
{
  // Member: is_waypoint_nav
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autonomous_navigation::msg::NavigationCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autonomous_navigation::msg::NavigationCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autonomous_navigation::msg::NavigationCommand *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_autonomous_navigation
const rosidl_message_type_support_t *
get_message_type_support_handle<autonomous_navigation::msg::NavigationCommand>()
{
  return &autonomous_navigation::msg::typesupport_fastrtps_cpp::_NavigationCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autonomous_navigation, msg, NavigationCommand)() {
  return &autonomous_navigation::msg::typesupport_fastrtps_cpp::_NavigationCommand__handle;
}

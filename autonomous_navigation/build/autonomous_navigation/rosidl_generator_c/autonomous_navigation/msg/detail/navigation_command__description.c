...
ROSIDL_GENERATOR_C_PUBLIC_autonomous_navigation
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x16, 0xeb, 0xd6, 0xa0, 0x27, 0xe5, 0xa8, 0x4f,
      0x30, 0x5b, 0x51, 0xd7, 0xc7, 0xbd, 0x10, 0x46,
      0x45, 0x6b, 0xf5, 0x04, 0x6f, 0x2e, 0xc6, 0xee,
      0xfe, 0x7c, 0xea, 0x1b, 0xe1, 0xc2, 0x54, 0xf5,
    }};
  return &hash;
}
...
static char autonomous_navigation__msg__NavigationCommand__TYPE_NAME[] = "autonomous_navigation/msg/NavigationCommand";
...
static char autonomous_navigation__msg__NavigationCommand__FIELD_NAME__is_waypoint_nav[] = "is_waypoint_nav";
static char autonomous_navigation__msg__NavigationCommand__FIELD_NAME__waypoints[] = "waypoints";

static rosidl_runtime_c__type_description__Field autonomous_navigation__msg__NavigationCommand__FIELDS[] = {
  {
    {autonomous_navigation__msg__NavigationCommand__FIELD_NAME__is_waypoint_nav, 15, 15},
    {
  ...
  {
    {autonomous_navigation__msg__NavigationCommand__FIELD_NAME__waypoints, 9, 9},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription autonomous_navigation__msg__NavigationCommand__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {autonomous_navigation__msg__NavigationCommand__TYPE_NAME, 43, 43},
      {autonomous_navigation__msg__NavigationCommand__FIELDS, 2, 2},
    },
    {autonomous_navigation__msg__NavigationCommand__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
autonomous_navigation__msg__NavigationCommand__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *autonomous_navigation__msg__NavigationCommand__get_individual_type_description_source(NULL),
